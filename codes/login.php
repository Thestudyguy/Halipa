...
<head>
	...
	<link rel="stylesheet" href="assets/css/misc-pages1.css">
...
<body class="simple-page">
	...
	<h4 class="form-title m-b-xl text-center"><a href="login.php"><img src="images/halipagray.png" width="140px" height="50px"></a></h4>
	
		<div class="form-group">
			<input type="text" class="form-control" placeholder="Enter Email" required="true" name="email">
		</div>
